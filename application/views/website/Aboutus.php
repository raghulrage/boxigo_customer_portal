          ...
          <h2 class="text-center title">About Us</h2>
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <h4 class="text-justify description">Boxigo is a modern startup that combines technology to the traditional packers and movers to provide you a safe, affordable and stress-free house shifting experience.<br><br>
                    Boxigo was born to fix the outrageous problem most people face on moving day - sudden price increases on moving quotes, bad service including rude staff, showing up late, damage to your belongings; and the lack of transparency throughout the entire process.
                    
                    <br><br>We more than a comparison site, it’s a tool to plan, compare, book and manage your move efficiently and smoothly.<br><br> 
                    Boxigo is a simple and secured platform for you to plan your local or long distance move and manage the entire process until your belongings arrive your new home/office. Simply enter your move details, compare prices and reviews, select a Mover, and book online. You’ll get instant access to handpicked, licensed and fully insured professional movers, as well as user reviews and recommendations. 
                    </h4>
                    
                </div>
                <div class="col-sm-4 mt-3">
                        <img style='height:320px;width:100%'src="https://cdn.dribbble.com/users/537533/screenshots/3112302/preview.gif" alt="image">
                </div>
            </div>
            <br><br><b><h4 class='text-center'>Our users rate our movers based on our community standards and are held accountable by us.</h4></b><br><br>
