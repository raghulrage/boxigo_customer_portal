...
class Estimate_model extends CI_model
{
	function insert_personal_data($data)
	{
		...
		if ($query->num_rows() > 0) {
			return true;//"Email or Phone number exists! If you have already made an estimate please login with your phone number to proceed";
		} else {
	...
	function generate_opt($phoneNumber)
	{
		$url = 'http://boxigo.in/boxigo-backend-api/product/customerOTPGeneration.php?number=91'.$phoneNumber;
